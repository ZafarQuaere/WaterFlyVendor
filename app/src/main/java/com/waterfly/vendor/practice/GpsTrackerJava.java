...
class GpsTrackerJava extends Service implements LocationListener {
    private final PokemonMapsActivity mContext;
    ...
    public GpsTrackerJava(PokemonMapsActivity context) {
