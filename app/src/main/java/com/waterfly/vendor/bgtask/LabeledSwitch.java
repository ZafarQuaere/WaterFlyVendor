...
public class LabeledSwitch extends ToggleableView {
    ...
    private void initView() {
        this.isOn = false;
        this.labelOn = Constants.TAG_ONLINE;
        this.labelOff = Constants.TAG_OFFLINE;

        this.enabled = true;
        this.textSize = (int)(28f * getResources().getDisplayMetrics().scaledDensity);
    ...
    private void initProperties(AttributeSet attrs) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            if (attr == R.styleable.Toggle_on) {
                ...
                int defaultTextSize = (int)(32f * getResources().getDisplayMetrics().scaledDensity);
